(function runGame() {
      ...
      <div class="devise-form form-table">
        <div class="form-table">
          <div id="question-section" style="display: none;">
            ...
            <h2>Find the multiple of 10 BELOW:</h2>
    ...
    function generateQuestion() {
        previousMultipleOfTen = Math.floor(Math.random() * 99) + 1;
        answer = Math.floor(previousMultipleOfTen/ 10) * 10;
        questionText.innerHTML = `<h2>${previousMultipleOfTen}</h2>`;
        answerInput.value = '';
        answerInput.focus();
    }
