(function runGame() {
    ...
    function generateQuestion() {
        // Generate first addend for the question (0-100 inclusive)
        firstAddend = Math.floor(Math.random() * 11) * 10;
        answer = 100 - firstAddend;
        questionText.innerHTML = `<h2>${firstAddend} + __ = 100</h2>`;
        answerInput.value = '';
        answerInput.focus();
    }
